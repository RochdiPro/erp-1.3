...
@Component({
  selector: 'app-devis-bl',
  templateUrl: './devis-bl.component.html',
  styleUrls: ['./devis-bl.component.scss']
})
export class DevisBLComponent implements OnInit {
  ...
  displayedColumns: string[] = ['radio','id_Devis', 'type', 'date_Creation','total_ttc' ,'Voir_pdf'];
