...
@Component({
  selector: 'app-dialog-content-add-article-dialog',
  templateUrl: './dialog-content-add-article-dialog.component.html',
  styleUrls: ['./dialog-content-add-article-dialog.component.scss']
})
export class DialogContentAddArticleDialogComponent implements OnInit {
  keyWord: any = [];
  prouduits : any =[]; 
  fromPage: any ; 
  prodChecked : any = [] ; 
...
sendProd(){
  ...
  filtre() {
    ...
    this.devisService.filtre_produit_id_nom(this.id, this.nom).subscribe((data) => {
      this.prouduits = data
    })
  }
}
