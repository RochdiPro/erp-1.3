...
export class EmployeServiceService {
  ...
  filtre_6champs (champ1 : any, valeur1 : any, champ2 : any, valeur2 : any, champ3 : any, valeur3 : any ,champ4 : any, valeur4 : any, champ5 : any, valeur5 : any, champ6 : any, valeur6 : any  )
    {
      return this.http.get(infonet + 'Filtre_employee_6_Champs', {
        params: {
          Champ1: champ1,
          Valeur1: valeur1,
          Champ2: champ2,
  ...
  Image_Employe(id) {
    return this.http.get(infonet + 'Image_Employee', {
      params: {
        Id: id
      }, responseType: 'blob'
    });
  ...
  obtenirListeChampsClient(): Observable<any> {
    return this.http.get(infonet + 'Liste_Champs_Employee', { observe: 'body' }).pipe(catchError(this.gererErreur)
    );
  }

  connexion(login:any , pwd :any)
  {
    return this.http.get(infonet + 'Connexion/', {
      params: {
        Login: login,
        Pwd: pwd
      }, observe: 'body'
  ...
  filtrerEmployes(champ: any, valeur: any): Observable<any> {
    ...
    return this.http.get(infonet + 'Filtre_Employee/', {
      params: {
        Champ: champ,
        Valeur: valeur
      }, observe: 'body'
  ...
  ListeEmployes(): Observable<any> {
    return this.http.get(infonet + 'Employees')
      .pipe(catchError(this.gererErreur)
      );
  }
  ...
  Employe(id): Observable<any> {   
    ...
    return this.http.get(infonet + 'Employee', {
      params: {
        Id: id
      }, observe: 'body'
    }).pipe(catchError(this.gererErreur)
  ...
  ajouterEmployes(Client) {
    ...
    return this.http.post(infonet + 'Creer_Employee', Client, { observe: "response" })
  }

  // suppression d'un employé par identifiant 
  SupprimerEmployes(formData) {

    return this.http.delete(infonet + 'Supprimer_Employee/', {
      params: {
        Id: formData
      }, observe: 'response'
    }).toPromise()
  ...
  ModifierEmployes(data: any): Observable<any> {
    console.log(data)
    return this.http.post(infonet + 'Modifier_Employee', data).pipe(
